...
public class ThirdPersonOrbitCamBasic : MonoBehaviour 
{
	...
	void Update()
	{
		// Get look movement to orbit the camera.
		// NOTE: was Input.GetAxis("Mouse X"/"Mouse Y")
		...
		angleH += Mathf.Clamp(look.x, -1, 1) * horizontalAimingSpeed;
		angleV += Mathf.Clamp(look.y, -1, 1) * verticalAimingSpeed;
