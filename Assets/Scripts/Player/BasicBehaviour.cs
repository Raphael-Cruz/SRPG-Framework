...
public class BasicBehaviour : MonoBehaviour
{
	...
	void Update()
	{
		...
		// NOTE: was UnityEngine.Input.GetAxis("Horizontal"/"Vertical"), which
		...
		sprint = Keyboard.current != null && Keyboard.current.leftShiftKey.isPressed;
	...
	// Attempt to lock on a specific behaviour.
	//  No other behaviour can override during the temporary lock.
